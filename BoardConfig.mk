...
# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := 1499157915

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 10214700 # This is the maximum known partition size, but it can be higher, so we just omit it
