...
DEVICE_CODE=PGN528
DEVICE_MANUFACTURER=condor
DEVICE_SOURCE=https://github.com/hocine-hj/twrp_device_PGN528.git
DT_DIR=device/condor/PGN528
GIT_USER_NANE=hocine-hj
GIT_USER_EMAIL=butcam3@gmail.com
GIT_COLOR_UI=false
###################################################################################
...
mka recoveryimage
curl --upload-file ./out/target/product/PGN528/recovery.img https://transfer.sh/twrp-Primo_RX5-001.img
